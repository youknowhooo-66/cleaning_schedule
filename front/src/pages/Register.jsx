        ...
        <div className="min-h-screen flex items-center justify-center bg-brand-50 py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
            ...
            <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-2xl border border-white/50 relative z-10">
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-black text-brand-950 tracking-tight">
                ...
                <form className="mt-8 space-y-5" onSubmit={handleRegister}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`group relative w-full flex justify-center py-4 px-4 border border-transparent text-sm font-bold rounded-2xl text-white bg-accent-500 hover:bg-accent-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 transition-all mt-6 ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:-translate-y-1 shadow-xl shadow-accent-500/30'}`}
                        >
                            {isLoading ? (
