                ...
                <form className="mt-8 space-y-6" onSubmit={handleLogin}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`group relative w-full flex justify-center py-4 px-4 border border-transparent text-sm font-bold rounded-2xl text-white bg-brand-600 hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:-translate-y-1 shadow-xl shadow-brand-500/30'}`}
                        >
                            {isLoading ? (
